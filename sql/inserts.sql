...
insert into Problema (desc_Problema, id_Professor, classificacao) values ("Imprima o numero 1", 1, "fácil");
insert into Problema (desc_Problema,  id_Professor, classificacao) values ("Imprima o numero 2", 2, "fácil");
insert into Problema (desc_Problema, id_Professor, classificacao) values ("Imprima o numero 3", 3, "média");
insert into Problema (desc_Problema, id_Professor, classificacao) values ("Imprima o numero 4",  4, "média");
insert into Problema (desc_Problema, id_Professor, classificacao) values ("Imprima o numero 5",  5, "difícil");
