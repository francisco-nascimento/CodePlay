    ...
    <div class="container">
      <div class="wrap-login100">
        <div  class="login100-pic js-tilt" data-tilt="" style="transform: perspective(300px) rotateX(7.8deg) rotateY(-3.01deg) scale3d(1.1, 1.1, 1.1); will-change: transform; transition: 400ms cubic-bezier(0.03, 0.98, 0.52, 0.99);">
          <img src="/codeplay/img/blockly/image.jpg" alt="IMG">
        </div>

        <form id="idLogin" action="/codeplay/loginCadastro/verificaLogin.php" method="POST">
        ...
        <form id="idCadastro" style="display:none" onsubmit="return validaCadastro();" name="formulario" action="/codeplay/loginCadastro/inserindo_dados_banco.php" method="POST">
            <span class="login100-form-title">
              Crie uma conta
            </span>
