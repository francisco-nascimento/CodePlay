...
<body>
  ...
  <p>
    ...
    <button onclick="recebeValor()"> Pega o valor</button>
    
  </p>

  <form action="teste.php" method="post" name="forulario">
    
    <input type="hidden" name="resposta" onsubmit="recebeValor()">
  ...
  <script>
    ...
    function recebeValor(){
      ...
      var input = document.formulario.resposta;

      input.value = code;

      alert(document.formulario.resposta.value);
