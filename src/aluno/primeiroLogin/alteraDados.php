...
<html lang="en">
<head>
	<title>Altere seus dados do Code && Play</title>
	<meta charset="UTF-8">
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" name="formulario" onsubmit="return validarSenha();" action="/aluno/primeiroLogin/atualiza.php" method="POST">
				<span class="contact100-form-title">
					Altere seus dados do Code && Play!
				</span>

				<div class="wrap-input100 validate-input" data-validate="Name is required">
					<span class="label-input100">Digite Seu Nome</span>
					<input class="input100" required="required" type="text" name="nome" placeholder="Enter your name" value="<?=$_SESSION['nome'];?>">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<span class="label-input100">Digite Seu Email</span>
					<input class="input100" required="required" type="text" name="email" placeholder="Enter your email addess" value="<?=$_SESSION['email'];?>">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate = "Valid Password is required: ">
					...
					<input type="password" class="input100" id="senha2" name="senha2" placeholder="********">
					<span class="focus-input100"></span>
				</div>
